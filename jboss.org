...
#+BEGIN_SRC powershell
D:\jboss\jboss-eap-${jboss_version}\bin
...
#+BEGIN_SRC powershell
D:\jboss\jboss-eap-${jboss_version}\bin
.\service.bat install /name jboss /controller localhost:9990  /jbossuser admin /jbosspass geheim > D:\jboss\jboss-eap-7.1\service.txt
#+END_SRC
