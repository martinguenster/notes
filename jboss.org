...
[Environment]::SetEnvironmentVariable( "JBOSS_HOME", $env:Path,[System.EnvironmentVariableTarget]::Machine) 

$env:NOPAUSE = 1
[Environment]::SetEnvironmentVariable( "NOPAUSE", $env:Path,[System.EnvironmentVariableTarget]::Machine) 
#+END_SRC
